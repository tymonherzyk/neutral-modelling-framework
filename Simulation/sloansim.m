...
%INITIALISATION%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [NS,dataFilename,Log] = sloansim(MainParameters,run)
...
FunctionParameters.a = functionParamsTable.Value{5};
FunctionParameters.sra = functionParamsTable.Value{6};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 2:replaceNo+1
    ...
    prob1=((FunctionParameters.nt-ni)/FunctionParameters.nt)*((FunctionParameters.m*FunctionParameters.p)+(1+FunctionParameters.a)*(1-FunctionParameters.m)*(ni/(FunctionParameters.nt-1)));
    prob2=(ni/FunctionParameters.nt)*((FunctionParameters.m*(1-FunctionParameters.p))+(1-FunctionParameters.a)*(1-FunctionParameters.m)*((FunctionParameters.nt-ni)/(FunctionParameters.nt-1)));
    prob3=1-prob1-prob2;
