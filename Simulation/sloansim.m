...
%START SLOANSIM%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [NS,dataFilename,Log] = sloansim(MainParameters,run) %start function
fprintf('SLOANSIM STARTED \n') %print hubbell start message
%START SETUP%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
FunctionParameters.a = FunctionParametersTable.Value{5};
...
for i = 2:replaceNo+1 %for number of replacement events
    ...
    prob1=((FunctionParameters.nt-ni)/FunctionParameters.nt)*((FunctionParameters.m*FunctionParameters.p)+(1+FunctionParameters.a)*(1-FunctionParameters.m)*(ni/(FunctionParameters.nt-1))); %calculate transitional probabilities
    prob2=(ni/FunctionParameters.nt)*((FunctionParameters.m*(1-FunctionParameters.p))+(1-FunctionParameters.a)*(1-FunctionParameters.m)*((FunctionParameters.nt-ni)/(FunctionParameters.nt-1))); %calculate transitional probabilities
